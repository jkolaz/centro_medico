...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2015 a las 00:39:35
...
(1, 'Alex Alcides', 'Salsavilca Perez', 'Admin', 'j.salsavilca@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2015-10-14 10:48:59', NULL, NULL, 'CM_562a5f1c83794', 1, 1);
...
CREATE TABLE `cm_secciones_pagina` (
...
CREATE TABLE `cm_tipo_administrador` (
...
CREATE TABLE `cm_tipo_administrador_pagina` (
...
ALTER TABLE `cm_administrador`
  ...
  ADD KEY `fk_cm_administrador_cm_tipo_administrador_idx` (`adm_ta_id`);
...
ALTER TABLE `cm_pagina`
  ...
  ADD KEY `fk_cm_pagina_cm_modulo1_idx` (`pag_mod_id`);
...
ALTER TABLE `cm_secciones_pagina`
  ...
  ADD KEY `fk_cm_secciones_pagina_cm_pagina1_idx` (`sp_pag_id`),
  ADD KEY `fk_cm_secciones_pagina_cm_secciones1_idx` (`sp_sec_id`);
...
ALTER TABLE `cm_tipo_administrador_pagina`
  ...
  ADD KEY `fk_cm_tipo_administrador_pagina_cm_tipo_administrador1_idx` (`tap_ta_id(11)`),
  ADD KEY `fk_cm_tipo_administrador_pagina_cm_pagina1_idx` (`tap_pag_id`);
